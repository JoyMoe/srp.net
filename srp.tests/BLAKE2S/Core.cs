...
public sealed partial class Blake2sCore
{
    ...
    private uint[] _h = new uint[8]; // stays the same
    private uint   _counter0;
    private uint   _counter1;
    private uint   _finalizationFlag0;
    private uint   _finalizationFlag1;
    ...
    public void Initialize(uint[] salt) //
    {
        if (salt == null) {
    ...
    public byte[] HashFinal(bool isEndOfLayer) {
        ...
        _finalizationFlag0 =  uint.MaxValue; //
